...
<section class="forms-section">
    <div class="forms">
        ...
        <form action="#" method="post" class="form form-login" style="box-shadow: 5px 5px 5px 5px #75a364;">
          <fieldset>
            ...
            <div class="input-block">
              ...
              <input id="login-email" type="email" name="email" style="border-radius: 15px;" required>
            </div>
            <div class="input-block">
              <label for="login-password">Password</label>
              <input id="login-password" type="password" name="password"  style="border-radius: 15px;" required>
            </div>
          </fieldset>
      ...
      <div class="form-wrapper">
        ...
        <form class="form form-signup" style="box-shadow: 5px 5px 5px 5px #75a364;">
          <fieldset>
            <legend>Please, enter your email, password and password confirmation for sign up.</legend>
            <div class="input-block">
              <label for="signup-email">E-mail</label>
              <input id="signup-email" type="email" name="email" style="border-radius: 15px;" required>
            </div>
            <div class="input-block">
              <label for="signup-password">Password</label>
              <input id="signup-password" type="password" name="password" style="border-radius: 15px;" required>
            </div>
            <div class="input-block">
              <label for="signup-password-confirm">Phone Number</label>
              <input id="signup-password-confirm" type="password" name="phone_number" style="border-radius: 15px;" required>
            </div>
          </fieldset>
