            ...
            <div class="row">
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        ...
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address: Innfront of Baytul Jame Masjid, House 232 ,Block C, Sadat Sobhan Tanvir Road,,Bashundhara R/A, Dhaka </p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+880-1712715511">+880-1712715511</a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i>Email: <a href="Mystic.Morsel810@gmail.com">Mystic.Morsel810@gmail.com</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
